...
function renderMobileMenu(filteredMenuItems, activeKey) {
  ...
  drawer.className = 'fixed inset-y-0 left-0 w-[120px] bg-white z-[99998] shadow-2xl transform -translate-x-full transition-transform duration-300 flex flex-col lg:hidden';
...
export async function renderSidebar(activeKey, containerId = 'sidebar-container') {
  ...
  // 레이아웃 스타일 보장
  container.className = 'w-[120px] pt-[5rem] shadow-right bg-white p-2 flex flex-col space-y-2 shrink-0';
