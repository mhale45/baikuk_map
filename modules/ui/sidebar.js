...
function renderMobileMenu(filteredMenuItems, activeKey) {
  ...
  drawer.className = 'fixed inset-y-0 left-0 w-[240px] bg-white z-[99998] shadow-2xl transform -translate-x-full transition-transform duration-300 flex flex-col lg:hidden';
